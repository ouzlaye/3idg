...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>3IDG<span>MALIKA</span></b></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span>Ajout a la Base  </span>
              </a>
            <ul class="sub">
              <li><a href="general.html">Ajouter Admin</a></li>
              <li><a href="buttons.html"> Ajouter Eleve </a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="grids.html">Eleves</a></li>
              <li><a href="calendar.html">Liste Externat</a></li>
              <li><a href="gallery.html">Liste Internat</a></li>
              <li><a href="todo_list.html">Recherche</a></li>
            </ul>
          </li>
         <!-- <li class="sub-menu">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action="AjoutEleve.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">Nom eleve</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="nom" name="nom" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">date de naissance</label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group ">
                    <label for="password" class="control-label col-lg-2">Prenom parent</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="prenom_pr" name="prenom_pr" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="confirm_password" class="control-label col-lg-2">Nom parent</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="nom_pr" name="nom_pr" type="text" />
                    </div>
                  </div>

                  <div class="form-group ">
                    <label for="confirm_password" class="control-label col-lg-2">Téléphone</label>
                    <div class="col-lg-10">
